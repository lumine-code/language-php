  ...
  describe("PHP tags", () => {
    ...
    it("tokenizes `include` on the same line as <?php", () => {
      ...
      expect(tokens[8]).toEqual({
        value: ">",
        scopes: ["text.html.php", "meta.embedded.line.php", "punctuation.section.embedded.end.php"],
      });
    });
    ...
    it("tokenizes namespaces immediately following <?php", () => {
      ...
      expect(tokens[1]).toEqual({
        value: " ",
        scopes: ["text.html.php", "meta.embedded.block.php", "source.php", "meta.namespace.php"],
      });
      expect(tokens[2]).toEqual({
        value: "namespace",
        scopes: [
...
`);
      ...
      expect(lines[0][0]).toEqual({
        value: "<",
        scopes: ["text.html.php", "meta.tag.script.html", "punctuation.definition.tag.html"],
      });
      expect(lines[0][1]).toEqual({
        value: "script",
        scopes: ["text.html.php", "meta.tag.script.html", "entity.name.tag.script.html"],
      });
    ...
    it("does not tokenize PHP tag syntax within PHP syntax itself inside HTML attributes (regression)", () => {
      ...
      expect(tokens[1]).toEqual({
        value: "img",
        scopes: ["text.html.php", "meta.tag.inline.img.html", "entity.name.tag.inline.img.html"],
      });
      expect(tokens[2]).toEqual({
        value: " ",
...
`);
      ...
      expect(lines[0][0]).toEqual({
        value: "#!",
        scopes: ["text.html.php", "comment.line.shebang.php", "punctuation.definition.comment.php"],
      });
      expect(lines[0][1]).toEqual({
...
`;
      ...
      expect(
        grammar.firstLineRegex.findNextMatchSync('<?xml version="1.0" encoding="UTF-8"?>'),
      ).toBeNull();
    });
...
`);
      ...
      expect(lines[0][3]).toEqual({
        value: " ",
        scopes: ["text.html.php", "meta.embedded.line.php", "source.php", "meta.use.php"],
      });
