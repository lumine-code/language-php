...
exports.activate = function () {
  ...
  lumine.grammars.addInjectionPoint("text.html.php", {
    type: "program",
    language: () => "html",
    content(node) {
...
exports.consumeHyperlinkInjection = (hyperlink) => {
  ...
  hyperlink.addInjectionPoint("comment.block.documentation.phpdoc.php", {
    types: ["description", "text", "uri"],
  });
};

exports.consumeTodoInjection = (todo) => {
  todo.addInjectionPoint("text.html.php", {
    types: ["comment"],
    language(node) {
      if (isPhpDoc(node)) return null;
    },
  });
  todo.addInjectionPoint("comment.block.documentation.phpdoc.php", {
